...
This script contains a number of utility funtions developed for the use in class for classification problems, namely for plotting
the results from neural networks. The functions have been kept in their original form, as presented to us in class. 
